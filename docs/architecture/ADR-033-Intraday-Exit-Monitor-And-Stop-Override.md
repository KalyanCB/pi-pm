...
**Related:** [ADR-030](./ADR-030-Live-Investing-Architecture.md), [ADR-031](./ADR-031-Unified-Execution-Architecture.md), [07_EXIT_DECISION_FRAMEWORK.md](../product-next/07_EXIT_DECISION_FRAMEWORK.md), [18_HUMAN_IN_LOOP_LIVE_INVESTING_PRD.md](../product-next/18_HUMAN_IN_LOOP_LIVE_INVESTING_PRD.md), [21_EXECUTION_WORKFLOW_PRD.md](../product-next/21_EXECUTION_WORKFLOW_PRD.md), [LIVE_TRADING_SAFETY_CHECKLIST.md](../execution/LIVE_TRADING_SAFETY_CHECKLIST.md)
...
| No `stop_loss_price` on position | `portfolio_positions` schema |
...
- `docs/product-next/07_EXIT_DECISION_FRAMEWORK.md` — trigger catalogue
- `docs/execution/LIVE_TRADING_SAFETY_CHECKLIST.md` — go-live gates
