...
**Related:** [PO_SIGNOFF_2026_06_04.md](../product-next/PO_SIGNOFF_2026_06_04.md), [14_ARCHITECTURE_IMPACT_ANALYSIS.md](../product-next/14_ARCHITECTURE_IMPACT_ANALYSIS.md)

---

## Context

Pi-PM has mature **deterministic ranking** and **validation** but no unified **recommendation** layer between validation and ARGS. Stakeholders conflate rankings with trade actions. Phase 2 introduces a Recommendation Platform governed by product PRDs in `docs/product-next/`.
...
The engine is the **only** component authorized to emit trade-oriented actions for the swing book ([01_RECOMMENDATION_ENGINE_PRD.md](../product-next/01_RECOMMENDATION_ENGINE_PRD.md)).
...
Conviction influences **sorting and band caps** within the top pool — it must replay byte-stable ([02_CONVICTION_SCORING_PRD.md](../product-next/02_CONVICTION_SCORING_PRD.md)).
...
Committee effectiveness is **measured** in [16_RECOMMENDATION_PERFORMANCE_PRD.md](../product-next/16_RECOMMENDATION_PERFORMANCE_PRD.md) — never fed back into generation.
...
Machines **propose**; humans **commit capital** ([11_HUMAN_IN_LOOP_EXECUTION_PRD.md](../product-next/11_HUMAN_IN_LOOP_EXECUTION_PRD.md)).
...
Portfolio enforces slots, sector limits, and cash — returns `PORTFOLIO_FULL` / `SECTOR_LIMIT_REACHED` reason codes ([16_WHY_NOT_RECOMMENDED_FRAMEWORK.md](../product-next/16_WHY_NOT_RECOMMENDED_FRAMEWORK.md)). LLMs do not size positions (MVP or future formula in [05](../product-next/05_PORTFOLIO_ENGINE_PRD.md) §10).
...
Populates trust metrics and [17_TRUST_DASHBOARD_VISION.md](../product-next/17_TRUST_DASHBOARD_VISION.md) before real money.
...
- [PO_SIGNOFF_2026_06_04.md](../product-next/PO_SIGNOFF_2026_06_04.md)
