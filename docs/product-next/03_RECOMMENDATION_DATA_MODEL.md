...
| `lifecycle_state` | varchar(32) | NOT NULL | See [04](./04_RECOMMENDATION_LIFECYCLE.md) |
| `conviction_score` | smallint | NOT NULL | 0–100 |
| `conviction_band` | varchar(16) | NOT NULL | |
| `conviction_components` | JSONB | NOT NULL | Sub-scores [02](./02_CONVICTION_SCORING_PRD.md) |
| `reason_codes` | JSONB | NOT NULL | string array — see [16_WHY_NOT_RECOMMENDED_FRAMEWORK.md](./16_WHY_NOT_RECOMMENDED_FRAMEWORK.md) |
...
One row per `recommendation_result` tracking realized performance. Populated on fill/close (paper or live). Foundation for [16_RECOMMENDATION_PERFORMANCE_PRD.md](./16_RECOMMENDATION_PERFORMANCE_PRD.md) and trust metrics.
...
See [04_RECOMMENDATION_LIFECYCLE.md](./04_RECOMMENDATION_LIFECYCLE.md).
