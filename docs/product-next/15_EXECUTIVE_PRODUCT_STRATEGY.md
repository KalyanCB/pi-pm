...
2. **Auto-execution without human confirm** — broker integration is advisory + approval queue only ([11_HUMAN_IN_LOOP_EXECUTION_PRD.md](./11_HUMAN_IN_LOOP_EXECUTION_PRD.md)).
...
Detail: [12_PRODUCT_ROADMAP_2026_2027.md](./12_PRODUCT_ROADMAP_2026_2027.md).
...
4. Conviction v1.1 weights (five factors, **no committee**) — signed [PO_SIGNOFF_2026_06_04.md](./PO_SIGNOFF_2026_06_04.md).
5. Maximum concurrent swing positions and cash floor ([05_PORTFOLIO_ENGINE_PRD.md](./05_PORTFOLIO_ENGINE_PRD.md)).
...
| Trust dashboard (future) | Six panels live per [17](./17_TRUST_DASHBOARD_VISION.md) | N/A |
...
Post-M2 analytics surface per [17_TRUST_DASHBOARD_VISION.md](./17_TRUST_DASHBOARD_VISION.md): recommendation win rate, conviction accuracy, exit effectiveness, strategy/regime/committee effectiveness (measure-only).
