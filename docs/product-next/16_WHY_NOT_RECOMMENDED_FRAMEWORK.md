...
**Date:** 2026-06-05  
**Related:** [01_RECOMMENDATION_ENGINE_PRD.md](./01_RECOMMENDATION_ENGINE_PRD.md), [03_RECOMMENDATION_DATA_MODEL.md](./03_RECOMMENDATION_DATA_MODEL.md)
...
| `CONVICTION_LOW` | Band `LOW` or `BLOCKED` | [02](./02_CONVICTION_SCORING_PRD.md) |
| `PORTFOLIO_FULL` | No open slots for new BUY | [05](./05_PORTFOLIO_ENGINE_PRD.md) |
...
- [01_RECOMMENDATION_ENGINE_PRD.md](./01_RECOMMENDATION_ENGINE_PRD.md) §6
