...
**Related:** [ADR-021](./ADR-021-Recommendation-Platform-Architecture.md), [ADR-022](./ADR-022-Recommendation-Performance-Framework.md), [08_AI_INVESTMENT_COMMITTEE_PRD.md](../product/08_AI_INVESTMENT_COMMITTEE_PRD.md)
...
The Investment Committee is positioned before the human, not after. It informs the human's decision. The human retains final authority on all entries and exits per [11_HUMAN_IN_LOOP_EXECUTION_PRD.md](../product/11_HUMAN_IN_LOOP_EXECUTION_PRD.md).
...
- [PO Sign-off 2026-06-05 (M3.1)](../po/PO_SIGNOFF_2026_06_04.md)
