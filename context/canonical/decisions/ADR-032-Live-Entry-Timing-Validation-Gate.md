...
**Related:** [ADR-021](./ADR-021-Recommendation-Platform-Architecture.md), [01_RECOMMENDATION_ENGINE_PRD.md](../product/01_RECOMMENDATION_ENGINE_PRD.md), [13_PO_BACKLOG.md](../product/13_PO_BACKLOG.md) (F-OPS-1, S-REC-2.2), [16_WHY_NOT_RECOMMENDED_FRAMEWORK.md](../product/16_WHY_NOT_RECOMMENDED_FRAMEWORK.md)

---

## Context

Pi-PM targets a **15–30 trading day swing book** ([15_EXECUTIVE_PRODUCT_STRATEGY.md](../po/15_EXECUTIVE_PRODUCT_STRATEGY.md)) with daily ingest → rank → validate → recommend. Implementation matches **R-ENTRY-02**: per-run `validation.status == insufficient_data` → max **WATCH** (`app/recommendation/engine.py:220-224`).
...
- [VALIDATION_DESIGN.md](../design/VALIDATION_DESIGN.md) — tail gap
- [daily-nifty500-batch-runbook.md](../runbooks/daily-nifty500-batch-runbook.md) — T+5 ingest
