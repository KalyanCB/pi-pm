...
|----------|--------|----------------|
| **P1** | Recommendation domain — tables, APIs, lifecycle | E-REC, E-LC, [03](../product/03_RECOMMENDATION_DATA_MODEL.md), [04](../product/04_RECOMMENDATION_LIFECYCLE.md) |
| **P2** | Deterministic recommendation generation + conviction engine | E-REC, E-CONV, [01](../product/01_RECOMMENDATION_ENGINE_PRD.md), [02](../product/02_CONVICTION_SCORING_PRD.md), [16_WHY_NOT](../product/16_WHY_NOT_RECOMMENDED_FRAMEWORK.md) |
| **P3** | Outcome tracking, performance analytics, trust metrics | E-OUT (new), [16_RECOMMENDATION_PERFORMANCE](../product/16_RECOMMENDATION_PERFORMANCE_PRD.md), [17_TRUST_DASHBOARD](../product/17_TRUST_DASHBOARD_VISION.md) |
| **P4** | Portfolio engine — sizing, allocation, cash | E-PORT, [05](../product/05_PORTFOLIO_ENGINE_PRD.md) |
...
|---------|-------|----------|
| F-OUT-1 Schema | `recommendation_outcomes` per [03](../product/03_RECOMMENDATION_DATA_MODEL.md) §3.4 | P1 (table) / P3 (populate) |
...
| F-OUT-4 Trust dashboard | Panels per [17](../product/17_TRUST_DASHBOARD_VISION.md) | P3+ |
...
| Feature | Story | Priority |
|---------|-------|----------|
| F-CONV-1 Formula v1.1 | Five-factor weights; **no committee** — [02](../product/02_CONVICTION_SCORING_PRD.md) | P2 |
...
- [12_PRODUCT_ROADMAP_2026_2027.md](../product/12_PRODUCT_ROADMAP_2026_2027.md)
