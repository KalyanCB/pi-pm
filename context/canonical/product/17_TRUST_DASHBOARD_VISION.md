...
Feeds executive narrative in [15_EXECUTIVE_PRODUCT_STRATEGY.md](../po/15_EXECUTIVE_PRODUCT_STRATEGY.md) and metrics in [16_RECOMMENDATION_PERFORMANCE_PRD.md](../product/16_RECOMMENDATION_PERFORMANCE_PRD.md).
...
| **Conviction accuracy** | Band vs outcome ([16](../product/16_RECOMMENDATION_PERFORMANCE_PRD.md) §4) | Do HIGH bands outperform LOW? |
