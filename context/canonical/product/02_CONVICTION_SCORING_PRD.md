...
Conviction is an **input** to the Recommendation Engine ([01_RECOMMENDATION_ENGINE_PRD.md](../product/01_RECOMMENDATION_ENGINE_PRD.md)), not a replacement for ranking.
...
| **Committee-neutral (mandatory)** | ARGS / committee outputs are **stored, displayed, and explained only** — they **must not** affect `conviction_score`, `conviction_band`, or `recommendation_action` ([PO_SIGNOFF_2026_06_04.md](../po/PO_SIGNOFF_2026_06_04.md)) |
...
See [08_AI_INVESTMENT_COMMITTEE_PRD.md](../product/08_AI_INVESTMENT_COMMITTEE_PRD.md) and [16_RECOMMENDATION_PERFORMANCE_PRD.md](../product/16_RECOMMENDATION_PERFORMANCE_PRD.md) for **measurement** of committee effectiveness (post-hoc only).
