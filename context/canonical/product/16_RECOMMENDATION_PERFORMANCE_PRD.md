...
**Date:** 2026-06-05  
**Foundation entity:** `RecommendationOutcome` ([03](../product/03_RECOMMENDATION_DATA_MODEL.md))

**Note:** Numbered **16** to avoid renumbering [11_HUMAN_IN_LOOP_EXECUTION_PRD.md](../product/11_HUMAN_IN_LOOP_EXECUTION_PRD.md).
...
Supports trust metrics, PO review, and [17_TRUST_DASHBOARD_VISION.md](../product/17_TRUST_DASHBOARD_VISION.md).

---

## 2. Data foundation

All metrics derive from `recommendation_outcomes` joined to `recommendation_results`, `ranking_runs`, and regime snapshots. See lifecycle closure in [04_RECOMMENDATION_LIFECYCLE.md](../product/04_RECOMMENDATION_LIFECYCLE.md) §11.
...
**Critical:** Band at scoring time uses **deterministic conviction only** ([02](../product/02_CONVICTION_SCORING_PRD.md)) — never committee-adjusted.
...
| `HIGH_CONCERN` | Outcome when flag set ([08](../product/08_AI_INVESTMENT_COMMITTEE_PRD.md)) |
...
Informs [05](../product/05_PORTFOLIO_ENGINE_PRD.md) slot table review — does not auto-change regime policy without PO gate.
...
Part of **P3 — Recommendation Outcomes** in [13_PO_BACKLOG.md](../product/13_PO_BACKLOG.md) (after P1 domain + P2 engine).

---

## 10. References

- [03_RECOMMENDATION_DATA_MODEL.md](../product/03_RECOMMENDATION_DATA_MODEL.md)
