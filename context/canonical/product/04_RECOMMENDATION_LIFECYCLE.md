...
| `APPROVED` | Human accepted entry; pending execution | Human ([11](../product/11_HUMAN_IN_LOOP_EXECUTION_PRD.md)) |
...
- Max concurrent `CANDIDATE` BUYs = open slots ([05](../product/05_PORTFOLIO_ENGINE_PRD.md)).
...
| Auto `REJECT` from engine | No queue entry; audit `reason_codes` ([16_WHY_NOT_RECOMMENDED_FRAMEWORK.md](../product/16_WHY_NOT_RECOMMENDED_FRAMEWORK.md)) |
...
- [03_RECOMMENDATION_DATA_MODEL.md](../product/03_RECOMMENDATION_DATA_MODEL.md) §3.4
- [16_RECOMMENDATION_PERFORMANCE_PRD.md](../product/16_RECOMMENDATION_PERFORMANCE_PRD.md)
- [11_HUMAN_IN_LOOP_EXECUTION_PRD.md](../product/11_HUMAN_IN_LOOP_EXECUTION_PRD.md)
