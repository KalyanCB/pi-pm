...
Engineering delivery order **within and across milestones** (see [13_PO_BACKLOG.md](../product/13_PO_BACKLOG.md)):
...
**Gate:** [PO_SIGNOFF_2026_06_04.md](../po/PO_SIGNOFF_2026_06_04.md), [ADR-021](../decisions/ADR-021-Recommendation-Platform-Architecture.md).
...
3. Conviction v1.1 — five deterministic factors; **committee removed** ([02](../product/02_CONVICTION_SCORING_PRD.md), [PO sign-off](../po/PO_SIGNOFF_2026_06_04.md)).

### Deliverables (product → engineering)

| # | Deliverable | PRD |
|---|-------------|-----|
| M1.1 | `recommendation_*` schema + migrations spec | [03](../product/03_RECOMMENDATION_DATA_MODEL.md) |
| M1.2 | Recommendation Engine v1 rules | [01](../product/01_RECOMMENDATION_ENGINE_PRD.md) |
| M1.3 | Conviction scoring v1 | [02](../product/02_CONVICTION_SCORING_PRD.md) |
| M1.4 | Lifecycle + approval audit | [04](../product/04_RECOMMENDATION_LIFECYCLE.md) |
| M1.5 | Packet `recommendation` block | [08](../product/08_AI_INVESTMENT_COMMITTEE_PRD.md) |
| M1.6 | Recommendation REST APIs + why-not | [01](../product/01_RECOMMENDATION_ENGINE_PRD.md) §9, [16_WHY_NOT](../product/16_WHY_NOT_RECOMMENDED_FRAMEWORK.md) |
| M1.7 | `recommendation_outcomes` schema | [03](../product/03_RECOMMENDATION_DATA_MODEL.md) §3.4 |
...
| # | Deliverable | PRD |
|---|-------------|-----|
| M2.1 | Portfolio service + APIs | [05](../product/05_PORTFOLIO_ENGINE_PRD.md) |
...
| M2.5 | ARGS live `portfolio_context` | [08](../product/08_AI_INVESTMENT_COMMITTEE_PRD.md) |
| M2.6 | Outcome population + performance rollup (P3) | [16_RECOMMENDATION_PERFORMANCE](../product/16_RECOMMENDATION_PERFORMANCE_PRD.md) |
...
| # | Deliverable | PRD |
|---|-------------|-----|
| M3.1 | Committee advisory enum + prompts | [08](../product/08_AI_INVESTMENT_COMMITTEE_PRD.md) |
| M3.2 | HITL approval APIs | [11](../product/11_HUMAN_IN_LOOP_EXECUTION_PRD.md) |
...
- [15_EXECUTIVE_PRODUCT_STRATEGY.md](../po/15_EXECUTIVE_PRODUCT_STRATEGY.md)
- [13_PO_BACKLOG.md](../product/13_PO_BACKLOG.md)
- [14_ARCHITECTURE_IMPACT_ANALYSIS.md](../product/14_ARCHITECTURE_IMPACT_ANALYSIS.md)
