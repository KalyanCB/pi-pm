...
**Research note:** `breakout_v1` 20d alpha concentrated in `BULL_LOW_VOL` ([HANDOFF.md](../../AGENTS.md)).
...
Do not run `compute_full_horizon_metrics` on 100k+ pooled rows — O(n²). Use `compute_pooled_period_metrics` ([HANDOFF.md](../../AGENTS.md)).
