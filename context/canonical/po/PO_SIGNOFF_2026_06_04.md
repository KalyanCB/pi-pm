...
| Change | Document(s) |
|--------|----------------|
| **M1** — Remove committee from conviction; five deterministic inputs only | [02_CONVICTION_SCORING_PRD.md](../product/02_CONVICTION_SCORING_PRD.md), [01](../product/01_RECOMMENDATION_ENGINE_PRD.md), [14](../product/14_ARCHITECTURE_IMPACT_ANALYSIS.md) |
| **M2** — `RecommendationOutcome` entity | [03](../product/03_RECOMMENDATION_DATA_MODEL.md), [04](../product/04_RECOMMENDATION_LIFECYCLE.md) |
| **M3** — Why-not-recommended framework | [16_WHY_NOT_RECOMMENDED_FRAMEWORK.md](../product/16_WHY_NOT_RECOMMENDED_FRAMEWORK.md) |
| **M4** — Recommendation performance PRD | [16_RECOMMENDATION_PERFORMANCE_PRD.md](../product/16_RECOMMENDATION_PERFORMANCE_PRD.md) |
| **ADR-021** — Governing architecture | [../decisions/ADR-021-Recommendation-Platform-Architecture.md](../decisions/ADR-021-Recommendation-Platform-Architecture.md) |
...
| Change | Document(s) |
|--------|----------------|
| Future position sizing formula (not MVP) | [05_PORTFOLIO_ENGINE_PRD.md](../product/05_PORTFOLIO_ENGINE_PRD.md) §10 |
| `HIGH_CONCERN` advisory level | [08_AI_INVESTMENT_COMMITTEE_PRD.md](../product/08_AI_INVESTMENT_COMMITTEE_PRD.md) |
| Trust dashboard vision | [17_TRUST_DASHBOARD_VISION.md](../product/17_TRUST_DASHBOARD_VISION.md) |
| Implementation priority P1–P7 | [13_PO_BACKLOG.md](../product/13_PO_BACKLOG.md), [12_PRODUCT_ROADMAP_2026_2027.md](../product/12_PRODUCT_ROADMAP_2026_2027.md) |
...
2. [ADR-021](../decisions/ADR-021-Recommendation-Platform-Architecture.md) committed.
...
Detail: [13_PO_BACKLOG.md](../product/13_PO_BACKLOG.md).
