...
## UX Spec Gaps (vs `context/canonical/frontend/`)
...
|----------|-------|---------|
| `context/canonical/design/domain-boundaries.md` | Not implemented | Full JWT flow |
...
**Accurate:** `context/canonical/frontend/FEATURE_INTEGRATION_REPORT.md` (phases 1–6).
