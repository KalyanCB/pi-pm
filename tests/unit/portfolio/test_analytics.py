...
def test_concentration_alert():
    ...
    r = compute_risk(
        positions, total_equity=1_000_000, cash_balance=750_000, single_name_cap_pct=18.0
    )
    codes = [a.code for a in r.alerts]
...
def test_drawdown_alert():
    ...
    r = compute_risk(
        positions, total_equity=1_000_000, cash_balance=900_000, current_drawdown_pct=12.0
    )
    codes = [a.code for a in r.alerts]
